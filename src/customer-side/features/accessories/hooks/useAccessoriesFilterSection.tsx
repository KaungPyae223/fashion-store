...
export const useAccessoriesFilterSection = () => {
  ...
  const [fetchUrl, setFetchUrl] = useState(baseUrl + "/filter-data/3");
  ...
  useEffect(() => {
    ...
    setFetchUrl(`${baseUrl}/filter-data/3?gender=${gender ? gender : "All"}`);
  }, [gender]);
