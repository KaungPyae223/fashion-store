    ...
    <div className="py-6 mb-6">
      <Container>
        <div className="col-span-6 flex flex-col items-start justify-center gap-5">
          ...
          <p className="text-sm cursor-pointer py-1 px-3 border border-blue-800 text-blue-800">View Details</p>
        </div>
        <div className="col-span-6">
          <img
            className="max-h-[500px] shadow-lg mx-auto object-cover object-center rounded-lg"
            alt="Nike Air Max"
