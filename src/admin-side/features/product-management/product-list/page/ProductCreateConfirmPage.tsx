    ...
    <div>
      <div className="flex flex-row justify-between items-center border-b pb-4">
        ...
        <div className="flex flex-col items-center">
          <p className="text-xl tracking-wide mb-3">Product Create Confirm</p>
          <BreadCrumb
            previousSection={[
              { link: "/admin/product-list", title: "Product List" },
              { link: "/admin/product-list/create", title: "Product Create" },
            ]}
            title="Confirm"
          />
        </div>
...
export default ProductCreateConfirmPage;
