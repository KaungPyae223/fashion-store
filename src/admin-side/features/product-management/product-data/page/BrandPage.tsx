...
const BrandPage = () => {
  ...
  const [brandImageUploadModel, setBrandImageUploadModel] =
    ...
    <div>
      ...
      <div className="flex flex-row justify-between items-center border-b pb-4">
        ...
        <div className="flex flex-col items-center">
          <p className="text-xl tracking-wide mb-3">Brands</p>
          <BreadCrumb
            previousSection={[
      ...
      <SingleImageUpload
        ...
        openModal={brandImageUploadModel}
        setOpenModal={setBrandImageUploadModel}
      />
    </div>
  );
};
