  ...
  return (
    <>
      <tr className=" text-gray-800 bg-white border-y-[12px] border-y-gray-100">
        <td className="text-start p-2 ps-4 py-4 ">{payment.payment}</td>
        ...
        <td className="  p-2 text-end">{payment.total_payments}</td>
        <td className="  p-2 text-end">{payment.total_amount}</td>
      ...
      <Modal openModal={openModal} setOpenModal={setOpenModal}>
        <UpdatePaymentForm setOpenModal={setOpenModal} oldData={payment} />
      </Modal>
    </>
  );
};
