...
const CategoryData = () => {
  return (
    <table className="w-full">
      ...
      <tbody>
        <CategoryDataTr category="Clothing" type="T-Shirt" />
        <CategoryDataTr category="Clothing" type="Ginger" />
        <CategoryDataTr category="Footwear" type="Sneaker" />
        <CategoryDataTr category="Accessories" type="Hat" />
        <CategoryDataTr category="Clothing" type="Skirt" />
...
const CategoryDataTr = ({
  ...
  return (
    <tr className="text-gray-700">
      <td className="text-start p-1 px-1.5 border border-gray-300">{type}</td>
