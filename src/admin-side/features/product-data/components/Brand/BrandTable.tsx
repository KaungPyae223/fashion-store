...
const BrandTable = ({ brands, handleRevalidate }) => {
  return (
    <div className="mt-6">
...
const BrandTr = ({ brand, handleRevalidate }) => {

  const [openNameUpdateForm, setOpenUpdateNameForm] = useState<boolean>(false);
  const [openUpdateImageForm, setOpenUpdateImageForm] = useState<boolean>(false);
  ...
  return (
    <>
      ...
      <div className="h-0">
        <Modal openModal={openNameUpdateForm} setOpenModal={setOpenUpdateNameForm}>
          <UpdateBrandNameForm
            handleRevalidate={handleRevalidate}
      ...
      <div className="h-0">
        <Modal openModal={openUpdateImageForm} setOpenModal={setOpenUpdateImageForm}>
