    ...
    <tr className="text-gray-800 bg-white border-y-[12px] border-y-gray-100">
      <td className="p-2 border-spacing-0">
        <div className="flex flex-row gap-6 items-center">
          ...
          />
          <p className="text-lg font-medium">Mr Michael</p>
        </div>
      </td>
      <td className="p-2 border-spacing-0">micheal123@gmail.com</td>
      <td className="p-2 border-spacing-0">09240274858</td>
      <td className="p-2 border-spacing-0">
        No 42 Ayethidar road yangon Thaunggyi Myanmar.
      </td>
