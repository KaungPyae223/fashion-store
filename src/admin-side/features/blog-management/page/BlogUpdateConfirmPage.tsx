...
import { updateBlog, updatePhoto } from "@/admin-side/services/blog";
import React from "react";
import { useRevalidatedData } from "@/hooks/useRevalidatedData";
import toast, { Toaster } from "react-hot-toast";

const BlogUpdateConfirmPage = () => {
  ...
  const handleSubmit = async () => {
    if (data.image) {
      await updatePhoto(data.id, data.image);
    }
...
export default BlogUpdateConfirmPage;
