  ...
  return (
    <div className="max-w-3xl mx-auto p-6 bg-white shadow-md mt-6">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-600 text-sm mt-3">{data.author} | {formatDate(data.time)}</p>
      </div>
      ...
      <div className="flex flex-row justify-end gap-3 mt-3 border-t border-t-gray-300 pt-6">
        <div className="px-5 py-1.5 border border-gray-500 duration-300 cursor-pointer hover:bg-gray-800 hover:text-white">Edit</div>
        <div className="px-5 py-1.5 border border-gray-500 duration-300 cursor-pointer hover:bg-gray-800 hover:text-white">Delete</div>
      </div>
    </div>
  );
};
