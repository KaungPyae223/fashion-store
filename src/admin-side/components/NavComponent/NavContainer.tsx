...
const NavContainer = ({ role, pathName }) => {
  switch (role) {
    case "System Admin":
      return <SystemAdmin pathName={pathName} />;
    case "Product Management":
      return <ProductManagement pathName={pathName} />;
    case "Order Management":
      return <OrderManagement pathName={pathName} />;
    case "Customer Support":
      return <CustomerSupport pathName={pathName} />;
    case "Super Admin":
      return <SuperAdmin pathName={pathName} />;
    case "Blog Management":
      return <BlogManagement pathName={pathName} />;
    default:
      return <div></div>;
  }
};

const SystemAdmin = ({ pathName }) => {
  return (
    <div className="mt-16">
...
const ProductManagement = ({ pathName }) => {
  return (
    <div className="mt-16">
...
const OrderManagement = ({ pathName }) => {
  return (
    <div className="mt-16">
...
const CustomerSupport = ({ pathName }) => {
  return (
    <div className="mt-16">
