...
export async function generateMetadata({ params: { q, id } }) {
  ...
  return {
    ...
    openGraph: {
      ...
      url: `https://alexa.com.mm/search/${q}/details/${product.DetailsData.id}`,
      images: [
        {
