...
import AdminDetailsPage from "@/admin-side/features/system-admin/admin-management/pages/AdminDetailsPage";
    ...
    <div>
      <div className="flex flex-row justify-between items-center border-b pb-4">
        ...
        <div className="flex flex-col items-center">
          <p className="text-xl tracking-wide mb-3">Admin Details</p>
          <BreadCrumb
            previousSection={[
