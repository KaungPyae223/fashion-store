...
import BlogUpdatePage from "@/admin-side/features/blog-management/page/BlogUpdatePage";
  ...
  return (
    <div>
      <div className="flex flex-row justify-between items-center border-b pb-4">
        <Link
          href={"/admin/blog-list/details/" + id}
        ...
        <div className="flex flex-col items-center">
          <p className="text-xl tracking-wide mb-3">Blog Update</p>
          <BreadCrumb
            previousSection={[
